...
def mesh5(m=3, n=4, order=1, pitch=18.7e-3, R_rod=6.15e-3, R_cooling=2.0e-3, gap_assembly=12e-3, R_core=None, smin=1.5e-3, add_cooling_rods=True, cooling_layout='central'):
